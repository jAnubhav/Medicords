    ...
    const handleAddRecord = async () => {
        ...
        const res = await fetch("http://localhost:5000/add-record", {
            ...
            body: JSON.stringify({
                ...
                "nationalId": shortenId(formData.nationalId),
        ...
        records.push({...newRecord, "date": res, "symptoms" : newRecord.symptoms.join(","), 
            "client_id": newRecord.client_id.replace(/\s+/g, "")}); setRecords(records);
                                    ...
                                    <div className="flex justify-between items-center flex-wrap gap-2 border-b border-gray-700 pb-4 mb-4">
                                        <div className="flex items-center">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-white font-medium">{record.client_id.replace(/(\d{4})/g, "$1 ")}</p>
                                            </div>
                                        </div>
